...
class OverlayView(context: Context?) : View(context) {
    ...
    private var results: MutableList<MetadataSibi.DetectionResult> = LinkedList<MetadataSibi.DetectionResult>()
    ...
    fun updateResults(
        detectionResults: MutableList<MetadataSibi.DetectionResult>,
        imageWidth: Int,
        imageHeight: Int
    ) {
